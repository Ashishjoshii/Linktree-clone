...
const GenerateContent = () => {
  ...
  const [handle, sethandle] = useState(searchParams.get('handle').toLowerCase())
    ...
    <div className='bg-[#d6a336] min-h-screen grid grid-cols-2'>
      ...
      <div className="col1 flex justify-center items-center flex-col text-gray-900">
        <div className='flex flex-col gap-5 my-8'>
          <h1 className='font-bold text-4xl mt-28'>Create your Bittree</h1>
          <div className="item">
      ...
      <div className="col2 w-full h-screen">
        <img className='h-full object-contain' src="/bittree2.png" alt="Generate your links" />
        <ToastContainer />
      </div>
    </div>
  )
