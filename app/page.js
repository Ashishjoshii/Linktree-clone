    ...
    <section className="bg-[#254f1a] min-h-[100vh] grid grid-cols-2">
      <div className="flex justify-center flex-col ml-[10vw] gap-1">
        ...
        <div className="input flex gap-2">
          ...
          <button onClick={()=> createTree()} className="bg-pink-500 rounded-full p-4 font-semibold">Claim your Bittree</button>
        </div>
      </div>
      <div className="flex items-center justify-center flex-col mr-[10vw]">
        <img className="size-96" src="/linktreehome.png" alt="homepage image"/>
      </div>
    </section>
